...
config.secret_key_base = ENV["SECRET_KEY_BASE"]
  ...
  # config.active_job.queue_name_prefix = "rails_devise_jwt_api_production"
...
# }
config.action_mailer.smtp_settings = {
  address: "smtp.groomwell.in",
  port: 587,
  authentication: "plain",
    user_name: ENV["GROOMWELL_USERNAME"],
  password: ENV["GROOMWELL_PASSWORD"],
